...
;; Keybindings under SPC m c
(map! :map org-mode-map
      :leader
      :prefix ("m c" . "clock/timestamp")
      :desc "Insert active timestamp"   "t" #'org-time-stamp
      :desc "Insert inactive timestamp" "a" #'org-time-stamp-inactive)

(setq org-agenda-log-mode-items '(clock state closed))
