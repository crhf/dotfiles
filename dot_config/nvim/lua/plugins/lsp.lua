...
return {
...

  {
    ...
    config = function(_, opts)
      ...
      -- Create a command to flip autostart_jdtls
      vim.api.nvim_create_user_command("JdtlsToggleAutoStart", function()
        vim.g.autostart_jdtls = not vim.g.autostart_jdtls
        if vim.g.autostart_jdtls then
          attach_jdtls()
        end
      end, {})

      -- Create a command to manually attach Jdtls
      vim.api.nvim_create_user_command("JdtlsAttach", attach_jdtls, {})
