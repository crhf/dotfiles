...
vim.keymap.set('n', 'zj', function() return "<cmd>lua leap_linewise()<cr>" end, {expr=true})
vim.keymap.set('x', 'zj', function()
...
vim.keymap.set('o', 'zj', "V<cmd>lua leap_linewise()<cr>", { desc = 'leap linewise visual' })
